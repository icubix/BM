...
class Child_Presentation extends Person_Presentation {
    #this overrides the spacing of person_presentation so the remove child button fits
    public function echoFields($location = 'child') {
...
/* End of file child_presentation.php */
/* Location: ./application/libraries/child_presentation.php */