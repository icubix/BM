...
<br>
         <div class="container-fluid">
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#today" aria-controls="today" role="tab" data-toggle="tab">Due Today</a></li>
                    <li role="presentation"><a href="#tomorrow" aria-controls="tomorrow" role="tab" data-toggle="tab">Due Tomorrow</a></li>
                    <li role="presentation"><a href="#nextweek" aria-controls="nextweek" role="tab" data-toggle="tab">Due Next Week</a></li>
                </ul>
